<?php get_header(); ?>    
    ...
    if (have_posts ()) {
        while (have_posts ()) {
            ...
            <div class="CxPost">
            	<div class="tpPost">
                	<p><?php foreach((get_the_category()) as $cat) { if (!($cat->cat_ID==6569)) echo '<a href="' . get_bloginfo('url') . '/category/' . $cat->category_nicename . '/">' . $cat->cat_name . '</a> ';} ?></p>
                    <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                </div>

	<?php 
	if ( in_category( 'completo' ))
		{ ?>
                ...
                <div class="metaPost">
                    ...
                    <div class="infos">
                        ...
                        <div class="autorPost">
                            ...
                            <p>Twitter: <a href="http://twitter.com/<?php the_author_nickname(); ?>" target="_blank">@<?php the_author_nickname(); ?></a></p>
                        </div>
                    </div>
                </div>
            </div>
